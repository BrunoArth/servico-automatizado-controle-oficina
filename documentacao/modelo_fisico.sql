...
CREATE TABLE public.Cliente(
	...
	tipo categoria_cliente NOT NULL DEFAULT 'Esporádico',
...
CREATE TABLE public.Agendamento (
	...
	situacao status_geral NOT NULL DEFAULT 'em espera',
...
ALTER TABLE Ordem_Servico ADD CONSTRAINT Ordem_Servico_fk2 FOREIGN KEY (id_supervisor) REFERENCES Funcionario(id);
...
ALTER TABLE Atividades_Realizadas ADD CONSTRAINT Atividades_Realizadas_fk3 FOREIGN KEY (id_funcionario) REFERENCES Funcionario(id);
